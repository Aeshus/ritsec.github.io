    ...
    <Hero 
        ...
        >
            ...
            <Fragment slot="bottom">
                <a class="link-button primary" href="https://github.com/ritsec/constitution/releases/latest/download/constitution.pdf">VIEW CONSTITUTION</a>
            </Fragment>

            <Fragment slot="image">
                <Picture src={heroImg} priority="true" width={1000} layout="constrained" formats={['avif', 'webp']} alt="Fall 2025 RITSEC Barbecue, showing off club members." />
            </Fragment>
